...
public interface UserDao {
	...
	User createUser(String username, String preferredName, String password) throws SQLException;
	void updateUserProfile(String username, String preferredName,  String newPassword) throws SQLException;
}
